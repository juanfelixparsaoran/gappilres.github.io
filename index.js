...
function vis1(data){
    ...
    d3.select('p').text('Visualisasi ini menggambarkan kelurahan-kelurahan di Provinsi Barat yang didapati adanya gap suara pada rekapitulasi di tingkat kelurahan dan tingkat kecamatan')
